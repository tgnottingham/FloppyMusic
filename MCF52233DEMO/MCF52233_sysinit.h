/*
 * File:		m52234evb_sysinit.h
 * Purpose:		Power-on Reset configuration of the MCF52234.
 *
 * Notes:
 *
 */

#ifndef __MCF52234_SYSINIT_H__
#define __MCF52234_SYSINIT_H__
